...
import plz.lizi.api.superbyte.tools.web.BadHttpRequest;
import plz.lizi.api.superbyte.tools.web.Webserver;
 ...
 *
 * @see plz.lizi.api.superbyte.tools.rmi.ObjectImporter
 */
public class AppletServer extends Webserver {
     ...
     *
     * @see plz.lizi.api.superbyte.tools.rmi.ObjectImporter#lookupObject(String)
     */
