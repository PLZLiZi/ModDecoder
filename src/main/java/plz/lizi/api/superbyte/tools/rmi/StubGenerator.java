...
import plz.lizi.api.superbyte.CtConstructor;
import plz.lizi.api.superbyte.CtField;
import plz.lizi.api.superbyte.CtMethod;
import plz.lizi.api.superbyte.CtNewConstructor;
import plz.lizi.api.superbyte.CtNewMethod;
import plz.lizi.api.superbyte.Modifier;
import plz.lizi.api.superbyte.NotFoundException;
import plz.lizi.api.superbyte.Translator;
import plz.lizi.api.superbyte.CtMethod.ConstParameter;
...
public class StubGenerator implements Translator {
     ...
     *
     * @see plz.lizi.api.superbyte.Translator#start(ClassPool)
     */
    @Override
     ...
     * Does nothing.
     * This is a method declared in javassist.Translator.
     * @see plz.lizi.api.superbyte.Translator#onLoad(ClassPool,String)
     */
    @Override
