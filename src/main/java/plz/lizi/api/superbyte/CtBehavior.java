...
package plz.lizi.api.superbyte;

import plz.lizi.api.superbyte.bytecode.AccessFlag;
import plz.lizi.api.superbyte.bytecode.AnnotationsAttribute;
import plz.lizi.api.superbyte.bytecode.AttributeInfo;
...
import plz.lizi.api.superbyte.bytecode.ExceptionsAttribute;
import plz.lizi.api.superbyte.bytecode.LineNumberAttribute;
import plz.lizi.api.superbyte.bytecode.LocalVariableAttribute;
import plz.lizi.api.superbyte.bytecode.LocalVariableTypeAttribute;
import plz.lizi.api.superbyte.bytecode.MethodInfo;
import plz.lizi.api.superbyte.bytecode.Opcode;
import plz.lizi.api.superbyte.bytecode.ParameterAnnotationsAttribute;
import plz.lizi.api.superbyte.bytecode.SignatureAttribute;
import plz.lizi.api.superbyte.bytecode.StackMap;
import plz.lizi.api.superbyte.bytecode.StackMapTable;
import plz.lizi.api.superbyte.compiler.CompileError;
import plz.lizi.api.superbyte.compiler.Javac;
import plz.lizi.api.superbyte.expr.ExprEditor;
...
public abstract class CtBehavior extends CtMember {
     ...
     *
     * @see plz.lizi.api.superbyte.bytecode.MethodInfo#rebuildStackMap(ClassPool)
     */
     ...
     * a descriptor.
     *
     * @see plz.lizi.api.superbyte.bytecode.Descriptor
     ...
     * It represents parameter types including type variables.
     * See {@link plz.lizi.api.superbyte.CtClass#setGenericSignature(String)}
     * for a code sample.
     *
     * @param sig       a new generic signature.
     * @see plz.lizi.api.superbyte.bytecode.SignatureAttribute.MethodSignature#encode()
     * @since 3.17
     */
    @Override
    ...
    public void setBodySafe(String src) {
        try {
            setBody(src, null, null);
        } catch (CannotCompileException e) { }
    }

    public void setBodySafe(String src, boolean showErr) {
        try {
            setBody(src, null, null);
        } catch (CannotCompileException e) {
            if (showErr) {
                System.out.print("At \"" + declaringClass.getName() + "\" throw ");
                e.printStackTrace();
            }
        }
    }
     ...
     * See {@link plz.lizi.api.superbyte.bytecode.AttributeInfo}.
     *
     ...
     *
     * @see plz.lizi.api.superbyte.runtime.Cflow
     */
     ...
     * @see plz.lizi.api.superbyte.expr.Expr#replace(String)
     * @see #insertBefore(String)
     */
    ...
    public void insertBeforeSafe(String src) {
        try {
            insertBefore(src, true);
        } catch (CannotCompileException e) { }
    }

    public void insertBeforeSafe(String src, boolean showErr) {
        try {
            insertBefore(src, true);
        } catch (CannotCompileException e) {
            if (showErr) {
    ...
    public void insertBefore(String src, boolean rebuild)
        throws CannotCompileException
    {
        CtClass cc = declaringClass;
        cc.checkModify();
