...
import plz.lizi.api.superbyte.bytecode.ConstantAttribute;
import plz.lizi.api.superbyte.bytecode.Descriptor;
import plz.lizi.api.superbyte.bytecode.EnclosingMethodAttribute;
import plz.lizi.api.superbyte.bytecode.FieldInfo;
import plz.lizi.api.superbyte.bytecode.InnerClassesAttribute;
...
import plz.lizi.api.superbyte.compiler.AccessorMaker;
...
class CtClassType extends CtClass {
   ...
   /**
        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    return plz.lizi.api.superbyte.bytecode.annotation.AnnotationImpl.make(
    ...
    /**
     * @see plz.lizi.api.superbyte.CtClass#prune()
     * @see plz.lizi.api.superbyte.CtClass#stopPruning(boolean)
     */
    @Override
    public void prune()
    {
