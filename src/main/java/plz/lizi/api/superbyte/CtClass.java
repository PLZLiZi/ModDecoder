...
public abstract class CtClass {
     ...
     */
    public plz.lizi.api.superbyte.compiler.AccessorMaker getAccessorMaker() {
        return null;
    }
     ...
     * @see plz.lizi.api.superbyte.bytecode.SignatureAttribute#toClassSignature(String)
     ...
     * @see plz.lizi.api.superbyte.bytecode.SignatureAttribute.ClassSignature#encode()
     ...
     *
     * @see plz.lizi.api.superbyte.CtConstructor
     */
     ...
     * are not included.
     *
     * @see plz.lizi.api.superbyte.CtMethod
     */
     ...
     *
     * @see plz.lizi.api.superbyte.CtField#CtField(CtField,CtClass)
     */
     ...
     *
     * @see plz.lizi.api.superbyte.CtField.Initializer#byExpr(String)
     * @see plz.lizi.api.superbyte.CtField#CtField(CtField,CtClass)
     */
     ...
     * @see plz.lizi.api.superbyte.bytecode.AttributeInfo
     */
