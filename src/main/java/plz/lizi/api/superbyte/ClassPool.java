...
import plz.lizi.api.superbyte.util.proxy.DefinePackageHelper;
 ...
 *
 * @see plz.lizi.api.superbyte.CtClass
 * @see plz.lizi.api.superbyte.ClassPath
 */
...
public class ClassPool {
     ...
     * @see plz.lizi.api.superbyte.ClassPool#getDefault()
     */
     ...
     * @see #get(String)
     * @see plz.lizi.api.superbyte.bytecode.ConstPool#getClassInfo(int)
     * @see plz.lizi.api.superbyte.bytecode.Descriptor#toCtClass(String, ClassPool)
     * @since 3.8.1
     */
     ...
     * @see plz.lizi.api.superbyte.ByteArrayClassPath
     */
     ...
     * @see plz.lizi.api.superbyte.ClassPath
     * @see plz.lizi.api.superbyte.URLClassPath
     * @see plz.lizi.api.superbyte.ByteArrayClassPath
     */
    ...
    {
        try {
            return plz.lizi.api.superbyte.util.proxy.DefineClassHelper.toClass(neighbor,
                                                            ct.toBytecode());
        }
        catch (IOException e) {
    ...
    {
        try {
            return plz.lizi.api.superbyte.util.proxy.DefineClassHelper.toClass(lookup,
                                                            ct.toBytecode());
        }
        catch (IOException e) {
            throw new CannotCompileException(e);
    ...
    {
        try {
            return plz.lizi.api.superbyte.util.proxy.DefineClassHelper.toClass(ct.getName(),
