...
package plz.lizi.api.superbyte.bytecode.annotation;
 ...
 *
 * @see plz.lizi.api.superbyte.bytecode.AnnotationsAttribute#getAnnotations()
 * @see plz.lizi.api.superbyte.bytecode.ParameterAnnotationsAttribute#getAnnotations()
 * @see MemberValue
...
public class Annotation {
     ...
     * the default value.
     *
     * @see plz.lizi.api.superbyte.bytecode.AnnotationDefaultAttribute
     */
