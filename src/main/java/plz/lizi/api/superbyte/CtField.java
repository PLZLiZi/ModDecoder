...
import plz.lizi.api.superbyte.compiler.SymbolTable;
...
public class CtField extends CtMember {
     ...
     * @see plz.lizi.api.superbyte.bytecode.SignatureAttribute.ObjectType#encode()
     * @since 3.17
     */
    @Override
     ...
     *
     * @see CodeConverter
     * @see plz.lizi.api.superbyte.expr.ExprEditor
     */
    ...
    public static abstract class Initializer {
         ...
         * @param objectType    the class instantiated for the initial value.
         *
         * @see plz.lizi.api.superbyte.CtField.Initializer#byNewArray(CtClass,int)
         * @see plz.lizi.api.superbyte.CtField.Initializer#byNewArray(CtClass,int[])
         */
